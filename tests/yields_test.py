...
def test_nomoto_Ia_w7():
    ...
    individual.set_metallicity(0.02)
    assert individual.C_12 == 5.20E-2
    assert individual.C_13 == 1.81E-11
    assert individual.N_14 == 9.56E-10
    assert individual.N_15 == 1.35E-10
    assert individual.O_16 == 1.85E-1
    assert individual.O_17 == 1.75E-10
    assert individual.O_18 == 7.40E-12
    assert individual.Mg_24 == 4.26E-3
    assert individual.Mg_25 == 1.81E-5
    assert individual.Mg_26 == 2.35E-5
    assert individual.S_32 == 7.80E-2
    assert individual.S_33 == 3.77E-4
    assert individual.S_34 == 2.20E-3
    assert individual.S_36 == 2.94E-7
    assert individual.Ca_40 == 1.15E-2
    assert individual.Ca_42 == 2.66E-5
    assert individual.Ca_43 == 1.49E-7
    assert individual.Ca_44 == 9.17E-6
    assert individual.Ca_46 == 3.26E-10
    assert individual.Ca_48 == 2.19E-12
    assert individual.Fe_54 == 0.115
    assert individual.Fe_56 == 0.668
    assert individual.Fe_57 == 1.96E-2
    assert individual.Fe_58 == 5.46E-4
    assert individual.Fe_60 == 7.33E-10
    assert individual.Cl_35 == 1.25E-4

    individual.set_metallicity(0.002)
    assert individual.C_12 == 5.44E-2
    assert individual.C_13 == 1.37E-12
    assert individual.N_14 == 8.11E-10
    assert individual.N_15 == 1.41E-8
    assert individual.O_16 == 0.135
    assert individual.O_17 == 1.27E-11
    assert individual.O_18 == 7.45E-13
    assert individual.Mg_24 == 9.74E-3
    assert individual.Mg_25 == 2.78E-6
    assert individual.Mg_26 == 2.96E-6
    assert individual.S_32 == 8.29E-2
    assert individual.S_33 == 1.16E-4
    assert individual.S_34 == 1.17E-4
    assert individual.S_36 == 2.25E-9
    assert individual.Ca_40 == 1.74E-2
    assert individual.Ca_42 == 1.49E-6
    assert individual.Ca_43 == 4.70E-8
    assert individual.Ca_44 == 1.42E-5
    assert individual.Ca_46 == 4.35E-11
    assert individual.Ca_48 == 2.90E-12
    assert individual.Fe_54 == 0.0882
    assert individual.Fe_56 == 0.724
    assert individual.Fe_57 == 0.0151
    assert individual.Fe_58 == 5.32E-4
    assert individual.Fe_60 == 6.97E-10
    assert individual.Cl_35 == 1.73E-5
